<section class="max-w-5xl mx-auto px-1 py-1">
  ...
  <div class="text-m uppercase opacity-50 mb-8 space-x-4">
    <div class="flex flex-col">
      ...
      <span>mounting: Top mount and gasket oring</span>
    </div>
  </div>

  <!-- Description -->
  <p class="mb-8 text-lg leading-relaxed">
    Juna is a 60% keyboard design inspired by the OTD 360c, created to deliver a
  ...
  <div class="mt-8 space-y-3">
    ...
    >
    <a
      href="https://www.youtube.com/watch?v=mXtgXobv9MA"
      class="block text-blue-600 hover:underline">Soundtest</a
    >
  </div>
</section>
